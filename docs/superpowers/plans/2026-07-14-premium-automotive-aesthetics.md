...
- [ ] **Step 1: Fejléc szegély scrolled állapothoz**
  ...
  - Amikor scrolled igaz, a szegély színe váltson `border-white/10` értékre:
    `scrolled ? "backdrop-blur-md bg-black/40 border-b border-white/10 shadow-lg" : "bg-transparent"` -> a szegélyszín változzon dinamikusan.
...
### Task 7: Szekciók, Űrlapok és Oldalak Színvilág Cseréi (Electric Blue)
**Files:**
- Modify:
...
- [ ] **Step 1: Színcserék és gomb shimmer / micro-interaction tuning az összes többi fájlban**
  ...
  - A gombokon és interaktív elemeken alkalmazd a `hover:scale-[1.02] active:scale-[0.98] transition-transform` transzformációkat és shimmer osztályt, ha fő CTA.
